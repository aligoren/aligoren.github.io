...
BLOG_AUTHOR = "Ali GOREN"  # (translatable)
BLOG_TITLE = "Ali GOREN"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://aligoren.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://aligoren.github.io/"
BLOG_EMAIL = "goren.ali@yandex.com"
BLOG_DESCRIPTION = "Programlama, Python, A\u00e7\u0131k Kaynak"  # (translatable)
...
INDEX_READ_MORE_LINK = '<p class="more"><a href="{link}">Devamını Oku…</a></p>'
# 'Read more...' for the RSS_FEED, if RSS_TEASERS is True (translatable)
RSS_READ_MORE_LINK = '<p><a href="{link}">Devamını Oku…</a> ({min_remaining_read})</p>'
